...
<div class="page-container">
	<form class="form form-horizontal" id="" action="NewsSeverlet?method=save_or_del&titles=${news.new_title}&pagenum=${pagenum}" method="post">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>文章标题：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="${news.new_title}" id="articletitle" name="articletitle" />
                 <input name="title" value="${news.new_title}" style="display:none;">			
			</div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9"> <span class="select-box">
				<select name="articlecolumn" class="select">
					...
					<option value="1">表彰公共</option>
					<option value="11">惩罚公告</option>
					<option value="12">校园趣事</option>
					<option value="13">体育活动</option>
				</select>
				</span> </div>
		</div>
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<textarea name="abstract" cols="" rows="" class="textarea"   onKeyUp="$.Huitextarealength(this,200)">${news.new_content}</textarea>
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<div class="uploader-thum-container">
					...
					<button style="position: relative;;top: 10px;" id="btn-star" class="btn btn-default btn-uploadstar radius ml-10">开始上传</button>
				</div>
			</div>
		</div>
		<!-- <div class="row cl">
...
<!--请在下方写此页面业务相关的脚本-->
<script type="text/javascript" src="moban2/lib/My97DatePicker/4.8/WdatePicker.js"></script>
<script type="text/javascript" src="moban2/lib/jquery.validation/1.14.0/jquery.validate.js"></script> 
<script type="text/javascript" src="moban2/lib/jquery.validation/1.14.0/validate-methods.js"></script> 
<script type="text/javascript" src="moban2/lib/jquery.validation/1.14.0/messages_zh.js"></script>
<script type="text/javascript" src="moban2/lib/webuploader/0.1.5/webuploader.min.js"></script> 
<script type="text/javascript" src="moban2/lib/ueditor/1.4.3/ueditor.config.js"></script> 
<script type="text/javascript" src="moban2/lib/ueditor/1.4.3/ueditor.all.min.js"> </script> 
<script type="text/javascript" src="moban2/lib/ueditor/1.4.3/lang/zh-cn/zh-cn.js"></script>
...
/* $a1(){
	//title
	var title=$("#input-text").valueOf();
	//类型
	var type=$("#select").valueOf();
	//日期
	var date=$("#input-text Wdate").valueOf();
	//内容
	var content=$(".editor").valueOf();
} */
	/* 
	...
	var uploader = WebUploader.create({
		auto: true,
		swf: 'moban2/lib/webuploader/0.1.5/Uploader.swf',
