...
<article class="page-container">
	...
	<form class="form form-horizontal" id="form-admin-add" action="client/UserInfoServlet?method=updateUserOrSaveUser" method="post">
	<input name="id" type="hidden" value="${user.id}" />
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>管理员：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${user.userName }" placeholder="登陆账号" id="userName" name="userName">
		</div>
	</div>
	<div class="row cl">
...
<!-- 	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="${user.mobilePhone }" placeholder="手机号" id="mobilePhone" name="mobilePhone">
		</div>
	</div>
	<div class="row cl">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" value="${user.role }" name="role" id="role" size="1">
				<option value="0">超级管理员</option>
				<option value="1">学生账号</option>
				<option value="2">教师账号</option>
				<option value="3">宿管账号</option>
			</select>
			</span> </div>
	</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" value="${user.isUsing }" name="isUsing" id="isUsing" size="1">
...
<%-- <%
if("save_error".equals(request.getParameter("message"))){ %>
...
<% }%>
<%
if("save_success".equals(request.getParameter("success"))){ %>
...
var error ='<%=request.getParameter("message")%>';
if(error.equals("save_error")){
 alert("添加失败!");
}
var success ='<%=request.getParameter("success")%>';
if(success.equals("save_success")){
 alert("添加成功!");
}
	...
	$("#form-admin-add").validate({
		...
		success:"valid",
		 /* submitHandler:function(form){
			$(form).ajaxSubmit({
				type: 'post',
				url: "client/UserInfoServlet?method=updateUserOrSaveUser" ,
